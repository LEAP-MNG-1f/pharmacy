...
export const Confirmation = () => {
  return (
    <div className="flex w-full h-full bg-white justify-center items-center py-20">
        ...
        <div className="w-full h-full flex flex-col rounded-xl items-center py-4">
          ...
          <div className="w-[95%] h-[8%] text-base  text-stone-700 font-semibold my-2">
            ...
            <textarea
              ...
              placeholder="жишээ нь: Мандах наран хотхон 123-в ..."
            ></textarea>
          </div>
          ...
          <div className=" h-[20%] w-[95%] font-bold flex items-center justify-between my-3">
            ...
            <button className="bg-[#00BBD3] w-[12%] h-[40%] text-white rounded-xl textarea-md p-1 justify-center items-center hover:bg-amber-300 hover:text-[#0b2c3b]">
              Захиалах
            </button>
          </div>
        </div>
